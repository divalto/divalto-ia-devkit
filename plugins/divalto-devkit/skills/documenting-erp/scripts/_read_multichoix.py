#!/usr/bin/env python3
# Vendored copy of .claude/skills/reading-multichoix/scripts/read_multichoix.py
# Source canonique : reading-multichoix. Ne pas modifier ici : toute evolution
# passe par la source canonique puis recopie (voir .claude/skills/README.md
# section "Autonomie des scripts / vendoring").
