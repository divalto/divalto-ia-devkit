...
| P04 | error | En-tete `xwin-projet` dans un .dhps | Utiliser `xwin-sprojet       2.0` |
| P05 | error | En-tete `xwin-sprojet` dans un .dhpt | Utiliser `xwin-projet        2.0` |
...
**Probleme** : un .dhps doit utiliser `xwin-sprojet`, pas `xwin-projet`.
...
**Probleme** : un .dhpt doit utiliser `xwin-projet`, pas `xwin-sprojet`.
