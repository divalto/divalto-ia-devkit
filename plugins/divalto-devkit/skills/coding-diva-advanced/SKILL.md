...
| 4 | Surcharge | OverWrittenBy/OverWrite, convention nommage U/UU | [overwrite-pattern.md](reference/overwrite-pattern.md) |
...
- [Surcharge](reference/overwrite-pattern.md) -- OverWrittenBy/OverWrite, convention U
